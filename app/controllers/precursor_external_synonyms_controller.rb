class PrecursorExternalSynonymsController < ApplicationController
  ...
  def index
    ...
    if params[:precursor_id]
      ...
      @precursor_external_synonyms = plugin_routes(:precursor_external_synonym,:many,params)
    end
  ...
  def show
    ...
    @precursor_external_synonym = plugin_routes(:precursor_external_synonym,:one,params)
